...
describe("Scrapper util", () => {
  ...
  it("should scrap notification data from raw html document", () => {
    ...
    expect(notifications).toEqual([
      ...
      {
        date: "01. 03. 2023.",
        dateTime: "Očekivano trajanje: 08:00 - 11:00",
        isUserStreet: false,
        note: "",
        place: "Mjesto: ZAGREB",
        reason: "Radovi: planirani",
        street: "Ulica: PUSTOSELINA 2-20 par, 1-9 nep",
      },
      {
        date: "01. 03. 2023.",
        dateTime: "Očekivano trajanje: 09:00 - 17:00",
        isUserStreet: true,
        note: "",
      ...
      {
        date: "01. 03. 2023.",
        dateTime: "Očekivano trajanje: 09:00 - 15:00",
        isUserStreet: false,
        note: "",
        place: "Mjesto: ZAGREB",
        reason: "Radovi: planirani",
        street:
          "Ulica: MATE UJEVIĆA 2-6 par, 1-7 nep, VLADIMIRA RUŽDJAKA 2/A, METELKOVA, BLAŽA LORKOVIĆA, JEĐUTOVA 2-10 par, 1-9 nep, HOTKO DRAGICE",
      },
      {
        date: "01. 03. 2023.",
        dateTime: "Očekivano trajanje: 08:30 - 11:30",
        isUserStreet: false,
        note: "",
        place: "Mjesto: ZAGREB",
        reason: "Radovi: planirani",
        street:
          "Ulica: ZORANIĆEVA, ULICA GRADA VUKOVARA 267, SUPILOVA 36, 23, RADNIČKA CESTA 36-40 par, MENČETIĆEVA 30, BUDMANIJEVA 2-do kraja par, 7-do kraja nep",
      },
    ]);
  });
});
