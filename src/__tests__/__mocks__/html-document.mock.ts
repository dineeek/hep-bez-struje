export const HTML_DOCUMENT_MOCK = `
<!doctype html>
...
<head>
	...
	<div class="bezstrujewrap" style="margin-top:50px;">
		...
		<select class="popispogona form-control pull-left" id="dp" onchange="location.href='?dp='+this.value;">
			...
			<option value='bjelovar'>Elektra Bjelovar</option><option value='cakovec'>Elektra Čakovec</option><option value='karlovac'>Elektra Karlovac</option><option value='koprivnica'>Elektra Koprivnica</option><option value='kriz'>Elektra Križ</option><option value='pozega'>Elektra Požega</option><option value='sisak'>Elektra Sisak</option><option value='sbrod'>Elektra Slavonski Brod</option><option value='sibenik'>Elektra Šibenik</option><option value='varazdin'>Elektra Varaždin</option><option value='vinkovci'>Elektra Vinkovci</option><option value='virovitica'>Elektra Virovitica</option><option value='zabok'>Elektra Zabok</option><option value='zadar'>Elektra Zadar</option><option value='zagreb' selected>Elektra Zagreb</option><option value='split'>Elektrodalmacija Split</option><option value='pula'>Elektroistra Pula</option><option value='dubrovnik'>Elektrojug Dubrovnik</option><option value='gospic'>Elektrolika Gospić</option><option value='rijeka'>Elektroprimorje Rijeka</option><option value='osijek'>Elektroslavonija Osijek</option>
		</select>
		<div class="clearfix"></div>
		
		
		<br/>
		<div class="elektra pull-left">Odaberite pogon</div>
		<select class="popispogona form-control pull-left" onchange="location.href='?dp='+$('#dp').val()+'&el='+this.value;">
			<option value='ZG' selected>Elektra Zagreb</option><option value='115'>Pogon  Samobor</option><option value='114'>Pogon  Velika Gorica</option><option value='177'>Pogon  Zaprešić</option><option value='113'>Pogon  Zelina</option><option value='187'>Pogon Dugo Selo</option><option value='118'>Pogon Sveta Klara</option>
		</select>
		<div class="clearfix"></div>
		...
		<div Class="karta">
			...
			<h3>Elektra Zagreb</h3>
			<hr>
			<a href='?dp=zagreb&el=ZG&datum=28.02.2023' class='dan'>UTO <div class='broj ima'>28</div></a><a href='?dp=zagreb&el=ZG&datum=01.03.2023' class='dan'>SRI <div class='broj ima'>1</div></a><a href='?dp=zagreb&el=ZG&datum=02.03.2023' class='dan'>ČET <div class='broj danas'>2</div></a><a href='?dp=zagreb&el=ZG&datum=03.03.2023' class='dan'>PET <div class='broj ima'>3</div></a><a href='?dp=zagreb&el=ZG&datum=04.03.2023' class='dan'>SUB <div class='broj ima'>4</div></a><a href='?dp=zagreb&el=ZG&datum=05.03.2023' class='dan'>NED <div class='broj ima'>5</div></a>
			...
			<div Class="radwrap">
					...
					<div class="mjesto tipR"> 
				    	...
				    	<div class="ulica"><strong>Ulica:</strong> BADLJEVINSKI PUT, KUSTOŠIJANSKA 71 </div>
					...
					<div class="mjesto tipR"> 
						<div class="grad"><strong>Mjesto:</strong> ZAGREB</div>
				    	<div class="ulica"><strong>Ulica:</strong> PUSTOSELINA 2-20 par, 1-9 nep </div>
					...
					<div class="mjesto tipR"> 
						<div class="grad"><strong>Mjesto:</strong> SESVETE</div>
				    	<div class="ulica"><strong>Ulica:</strong> TRAKOŠĆANSKA 36, KAŠINSKI ODVOJAK, KAŠINSKA 40/A, 40/B, 42-58 par, 29-55 nep </div>
				    	
				    </div>
					<div class="vrijeme tipR"><strong>Očekivano trajanje:</strong> 
						<div class="kada">09:00 - 17:00</div>
						<div class="tip">Radovi: planirani</div>
					</div>	
					<div class="clear"></div>
					<hr>
					...
					<div class="mjesto tipR"> 
						<div class="grad"><strong>Mjesto:</strong> ZAGREB</div>
				    	<div class="ulica"><strong>Ulica:</strong> MATE UJEVIĆA 2-6 par, 1-7 nep, VLADIMIRA RUŽDJAKA 2/A, METELKOVA, BLAŽA LORKOVIĆA, JEĐUTOVA 2-10 par, 1-9 nep, HOTKO DRAGICE </div>
				    	
				    </div>
					<div class="vrijeme tipR"><strong>Očekivano trajanje:</strong> 
						<div class="kada">09:00 - 15:00</div>
						<div class="tip">Radovi: planirani</div>
					</div>	
					<div class="clear"></div>
					<hr>
					...
					<div class="mjesto tipR"> 
						<div class="grad"><strong>Mjesto:</strong> ZAGREB</div>
				    	<div class="ulica"><strong>Ulica:</strong> ZORANIĆEVA, ULICA GRADA VUKOVARA 267, SUPILOVA 36, 23, RADNIČKA CESTA 36-40 par, MENČETIĆEVA 30, BUDMANIJEVA 2-do kraja par, 7-do kraja nep </div>
				    	
				    </div>
					<div class="vrijeme tipR"><strong>Očekivano trajanje:</strong> 
						<div class="kada">08:30 - 11:30</div>
						<div class="tip">Radovi: planirani</div>
					</div>	
					<div class="clear"></div>
					<hr>
		...
		<br/><br/><br/>
						...
						<div class="col-md-4 desno">
							...
							<ul class="box">
								<li><a href='javascript:;' class='root'>Poveznice</a></li><li><a href='https://mojamreza.hep.hr/index.html '  target='_blank'>Moja mreža / dostava očitanja</a></li><li><a href='https://www.hep.hr/ods/pristup-mrezi/distribucijska-podrucja-elektre/25'  target='_blank'>Distribucijska područja (elektre)</a></li><li><a href='/ods/ostalo/poveznice/bez-struje/19'  class='last'>Bez struje</a></li>
							</ul>
							
							<ul class="box">
								<li><a href="javascript:;" class="root">NOVOSTI</a></li>
								<li><a href='/ods/elektra-zagreb-zapocela-s-opseznim-radovima-na-uvodjenju-napredne-mreze/739'>Elektra Zagreb započela s opsežnim radovima na uvođenju napredne mreže </a></li><li><a href='/otvoren-natjecaj-za-dodjelu-donacija-za-2023-godinu/3721'>Otvoren natječaj za dodjelu donacija za 2023. godinu</a></li><li><a href='/nastavlja-se-otpis-potrazivanja-od-kupaca-na-potresom-pogodjenom-podrucju/3720' class='last'>Nastavlja se otpis potraživanja od kupaca na potresom pogođenom području</a></li>
							</ul>
	  ...
	  ga('gdizajn.send', 'pageview');
		...
		<div class="cookie-banner">
			<div class="cb-container center">
				...
				<div class="cb-col"><p>U obavljanju djelatnosti,&nbsp; HEP- Operator distribucijskog sustava d.o.o. prikuplja i obrađuje osobne podatke, poštujući sve relevantne zakonske i podzakonske akte RH i EU štiti vašu privatnost i prema vašim osobnim podacima odnosi se s posebnom pažnjom. <a href="https://www.hep.hr/ods/o-nama/zastita-osobnih-podataka/657">Više</a></p>
				<p>U svrhu pružanja boljeg korisničkog iskustva, HEP grupa koristi kolačiće (cookies). Nastavkom pregleda stranice ili klikom na gumb &quot;U redu&quot; pristajete na korištenje kolačića. <a href="http://www.hep.hr/zastita-podataka/zastita-podataka-hep-grupe/izjava-o-kolacicima/3347">Saznajte više</a> </p></div>
				<div class="cb-col">
					<button type="button" class="cb-btn agree-button">U redu</button>				
				</div>
			</div>
		</div>
